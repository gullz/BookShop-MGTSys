...
Public Class reptInvoiceRetail
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "Bookshop.reptInvoiceRetail.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedreptInvoiceRetail
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As reptInvoiceRetail = New reptInvoiceRetail
        rpt.Site = Me.Site
        Return rpt
    End Function
