...
Public Class ReptStockStatus
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "Bookshop.ReptStockStatus.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedReptStockStatus
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As ReptStockStatus = New ReptStockStatus
        rpt.Site = Me.Site
        Return rpt
    End Function
