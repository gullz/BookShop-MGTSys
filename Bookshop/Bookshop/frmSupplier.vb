Public Class frmSupplier
    ...
    Private Sub btnSave_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles btnSave.Click
        If Not checkText() Then
            ...
            setData("Supplier", quote + txtCompanyName.Text + commawithquote + "" + commawithquote + txtSupplierID.Text + commawithquote + txtNo.Text + commawithquote + txtStreet.Text + commawithquote + _
    ...
    Private Sub frmRetailer_Load(ByVal sender As Object, ByVal e As System.EventArgs) Handles Me.Load
        txtSupplierID.Text = getNewOtherID("SUP1", "Supplier")
        updateDGV()
    End Sub
    ...
    Private Sub btnClear_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles btnClear.Click
        clearText()
        txtSupplierID.Text = getNewOtherID("SUP1", "Suplier")
    End Sub
