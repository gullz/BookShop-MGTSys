...
Public Class reptAccessData
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "Bookshop.reptAccessData.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedreptAccessData
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As reptAccessData = New reptAccessData
        rpt.Site = Me.Site
        Return rpt
    End Function
